...
class UpdateUserView extends StatefulWidget {
  final Tutor tutor;
  UpdateUserView({this.tutor});
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _UpdateUserView(tutor: tutor);
  }
}

class _UpdateUserView extends State<UpdateUserView> {
  final Tutor tutor;
  List<String> subjects = setting.subjects;
  List<String> grades = setting.grades;
  var _grades;
  var _subjects;
  _UpdateUserView({this.tutor});
                              ...
                              children: <Widget>[
                                MultiSelectDialogField(
                                  ...
                                  chipDisplay: MultiSelectChipDisplay(
                                    items: model.tutor.grade
                                        ?.map((e) =>
                                            MultiSelectItem<String>(e, e))
                                        ?.toList(),
                                    onTap: (value) {
                                      setState(() {
                                        model.tutor.grade.remove(value);
                                      });
                                    },
                                  ),
                                ),
                            ...
                            child: Column(
                              children: <Widget>[
                                MultiSelectDialogField(
                                  ...
                                  chipDisplay: MultiSelectChipDisplay(
                                    items: model.tutor.subject
                                        ?.map((e) =>
                                            MultiSelectItem<String>(e, e))
                                        ?.toList(),
                                    onTap: (value) {
                                      setState(() {
                                        model.tutor.subject.remove(value);
                                      });
                                    },
                                  ),
                                ),
