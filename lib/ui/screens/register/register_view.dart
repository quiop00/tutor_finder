                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('Đang tạo tài khoản cho ${model.isStudent?'Học viên':'Gia sư'}', style: TextStyle(color:Colors.white),)
                              ],
                            ),
                          ),
                        ),
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: Colors.white,
                                        border: Border.all(
                                            color: model.isStudent?Colors.green:Colors.white,
                                            width: 1
                                        ),
                                        boxShadow:[
                                          BoxShadow(
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: Colors.white,
                                        border: Border.all(
                                            color: model.isStudent?Colors.white:Colors.green,
                                            width: 1
                                        ),
                                        boxShadow:[
                                          BoxShadow(
                        ...
                        children: [
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: Icon(Icons.person_outline,color: color,)
                            ),
                            validator: (input){
                              if(input.length==0){
                          ...
                          TextFormField(
                            ...
                            validator: (input){
                              ...
                              else if(!RegExp(r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+").hasMatch(input)){
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                hintText: 'Mật khẩu',
                                suffixIcon: InkWell(
                                    child: Icon(model.isVisible?Icons.visibility_off:Icons.visibility,color:color),
                                    onTap: (){
                                      setState(() {
                          ...
                          Container(
                            child: Row(
                              ...
                              children: [
                                ...
                                Flexible(child: Text('Tôi đồng ý với chính sách và điều khoản của CNPM',maxLines: 3,))
                              ],
                            ),
                          ),
                          ElevatedButton(
                            ...
                            onPressed: model.isAccept?()async{
                              if(!_formKey.currentState.validate()){
                                return;
                              }
                              _formKey.currentState.save();
                              await model.register();
                              dialog.showAlertDialog(context, 'Thông báo', model.message);
